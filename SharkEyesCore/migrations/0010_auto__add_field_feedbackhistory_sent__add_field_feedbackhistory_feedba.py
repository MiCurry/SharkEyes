...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'SharkEyesCore_feedbackhistory', 'feedback_date',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2016, 7, 25, 0, 0), max_length=100),
                      keep_default=False)
    ...
    models = {
        u'SharkEyesCore.feedbackhistory': {
            ...
            'feedback_date': ('django.db.models.fields.CharField', [], {'default': 'datetime.datetime(2016, 7, 25, 0, 0)', 'max_length': '100'}),
