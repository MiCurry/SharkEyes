...
def save_feedback(request):
    ...
    try:
        ...
        cursor = connection.cursor()
        #Execute SQL Query
        cursor.execute("""INSERT INTO SharkEyesCore_feedbackhistory (feedback_name, feedback_email, feedback_phone, feedback_title, feedback_comments, sent ) VALUES (%s, %s, %s);""", (feedback_name, feedback_email, feedback_phone, feedback_title, feedback_comment, sent))
        #Nothing needs to be returned
    except IntegrityError as e:
        print "Error Message: "
        print e.message
